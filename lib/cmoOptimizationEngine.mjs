...
import { LINKEDIN_CORE_HASHTAG, LINKEDIN_TOPIC_HASHTAGS, isLinkedInPlatform } from "./cmoLinkedInRules.mjs";
...
function buildOptimization(row = {}) {
  ...
  const baseHashtags = isLinkedInPlatform(platform)
    ? [LINKEDIN_CORE_HASHTAG, ...LINKEDIN_TOPIC_HASHTAGS.slice(0, 4)]
