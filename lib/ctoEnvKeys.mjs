export const ctoProviderEnvMap = {
  ...
  canva: {
    ...
    aliases: [
      'CANVA_ACCESS_TOKEN',
      'CANVA_API_TOKEN',
      'CTO_PROVIDER_CANVA_ACCESS_TOKEN',
      'CTO_CANVA_ACCESS_TOKEN',
      'GOPU_CTO_CANVA_ACCESS_TOKEN'
    ]
  },
  slack: {
  ...
  meta: {
    primary: 'META_PAGE_ACCESS_TOKEN',
    aliases: ['META_PAGE_ACCESS_TOKEN', 'META_ACCESS_TOKEN']
  },
  meta_access_token: {
    primary: 'META_PAGE_ACCESS_TOKEN',
    aliases: ['META_PAGE_ACCESS_TOKEN', 'META_ACCESS_TOKEN']
  ...
  facebook_page_id: {
    primary: 'META_PAGE_ID',
    aliases: ['META_PAGE_ID', 'FACEBOOK_PAGE_ID']
  },
  youtube: {
